...
|------|------|------|-----|---------------|------|
| 4c8g 云 | /hello | wrk **4线程** 1万连接 | **40,500** | - | 空载 |
| 4c8g 云 | /hello | wrk 4线程 1万连接 | **37,953** | 156% | 空载（test_qps_cpu.sh 含 CPU 监控） |
| 4c8g 云 | /hello | wrk 4线程 1万连接 | **34,330** | 146% | **十万长连接下**（约 20 万连接背景） |
...
**云服务器测试结果（4c8g 5M 带宽）：**
- **1万连接**: QPS 约 37,953～40,500（wrk 4 线程；无长连接背景时更高）
- **10万/20万长连接下**: QPS 约 34,330，CPU 146%；QPS 较空载下降约 **9～11%**
